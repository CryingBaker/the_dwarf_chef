...
import 'package:the_dwarf_chef/constants.dart';
...
class MyBottomNavBar extends StatelessWidget {
                ...
                press: () {
                  ...
                  if (navItems.items[index].destinationChecker()) {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => navItems.items[index].destination ?? SizedBox.shrink(),
                      ),
                    );
                  }
                },
  ...
  IconButton buildIconNavBarItem(
      {required String icon, required VoidCallback press, bool isActive = false}) {
    return IconButton(
